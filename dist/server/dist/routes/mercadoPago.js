...
import { applyMercadoPagoPayment } from "../database.js";
import { getMercadoPagoPayment, validateMercadoPagoWebhookSignature } from "../mercadoPago.js";
...
function getWebhookType(body, query) {
    const payload = body;
...
async function applyPaymentById(paymentId) {
