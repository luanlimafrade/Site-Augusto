...
import { createRsvp, deleteRsvp, getStats, listRsvps, updateRsvp } from "../database.js";
...
rsvpRouter.post("/", rsvpLimiter, async (req, res, next) => {
    ...
    try {
        ...
        return res.status(201).json({
            message: "Confirmação recebida com carinho. Ficamos muito felizes em compartilhar este momento com você.",
            rsvp
        });
    }
    catch (error) {
